...
Rudi is a rudimentary configuration management tool. It can be used to to 
configure a few servers for production service of a simple PHP web 
application or some other, not very challenging, task
 
Features:

* Rudi provides an abstraction that allows specifying a file's content and 
...
[rudi.md](rudi.md). Also, send any questions to the author:
